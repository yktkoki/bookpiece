(function () {
  ...
  var BASE_QUESTIONS = {
    low: [
      ...
      { text: 'どうしてこの本《ほん》を読《よ》もうと思《おも》ったの？', zone: 'start' },
      { text: 'この本《ほん》で、いちばん話《はな》したいことはなに？', zone: 'mid' },
      { text: 'いちばん心《こころ》にのこったのは、どこかな？', zone: 'mid' },
      { text: 'そこを読《よ》んで、どんな気持《きも》ちになった？', zone: 'mid' },
      { text: '自分《じぶん》とおなじだなと思《おも》ったところはある？', zone: 'mid' },
      { text: 'この本《ほん》を読《よ》んで、これからやってみたいことは？', zone: 'end' }
    ],
    mid: [
      { text: 'この本は、どんなお話ですか？', zone: 'start' },
      { text: 'どうしてこの本を読もうと思ったの？', zone: 'start' },
      { text: 'この本のことで、いちばん話したいことは何？', zone: 'mid' },
      { text: 'いちばん心に残った場面はどこ？どうしてそこが心に残ったの？', zone: 'mid' },
      { text: 'その場面で、登場人物はどんな気持ちだったと思う？', zone: 'mid' },
      { text: 'この本を読んで、はじめて分かったことや知ったことは？', zone: 'mid' },
      { text: 'もし自分だったら、どうする？', zone: 'mid' },
      { text: 'この本を読んで、自分が変わったことや、新しく得たものは？', zone: 'end' },
      { text: 'これから、どんなことをしてみたい？', zone: 'end' }
    ],
    high: [
      { text: 'この本は、どんな内容の本？かんたんにまとめてみよう', zone: 'start' },
      { text: 'この本を読もうと思った理由は？題名や表紙から、どんな本だと想像した？', zone: 'start' },
      { text: 'この本について、いちばん話したいことは何？', zone: 'mid' },
      { text: 'いちばん印象に残った場面はどこ？それはなぜ？', zone: 'mid' },
      { text: 'その場面で、登場人物はどんな気持ちだったと思う？そう考えた理由もおしえて', zone: 'mid' },
      { text: '登場人物は、物語の中でどう変わっていった？そのきっかけは何だったと思う？', zone: 'mid' },
      { text: '自分と登場人物で、にているところ・ちがうところはどこ？', zone: 'mid' },
  ...
  var FOLLOWUP_QUESTIONS = {
    low: [
      { text: '題名《だいめい》や表紙《ひょうし》を見《み》たとき、どんなお話《はなし》だと思《おも》った？', zone: 'start' },
      { text: 'ほかに心《こころ》にのこったところはある？', zone: 'mid' },
      { text: 'この本《ほん》で、はじめて知《し》ったことはある？', zone: 'mid' },
      { text: '「どうしてかなあ」と思《おも》ったところはある？', zone: 'mid' },
      { text: '自分《じぶん》にも、おなじようなことはなかったかな？', zone: 'mid' },
      { text: 'もし自分《じぶん》がその話《はなし》に出《で》てきたら、なにをしたい？', zone: 'mid' },
      { text: 'いちばん好《す》きな絵《え》や場面《ばめん》はどこ？', zone: 'mid' },
      { text: '出《で》てきた人《ひと》に、言《い》いたいことはある？', zone: 'end' },
      { text: 'この本《ほん》を、だれにすすめたい？どうして？', zone: 'end' }
    ],
    mid: [
      { text: '題名や表紙を見て、読む前はどんなお話だと思った？', zone: 'start' },
      { text: 'ほかに印象に残った場面はある？', zone: 'mid' },
      { text: '登場人物で、お話の中で変わっていった人はいる？どんなふうに変わった？', zone: 'mid' },
      { text: '自分とにているところ、ちがうところはどこ？', zone: 'mid' },
      { text: '腹が立ったところや、「どうしてかなあ」と思ったところはある？', zone: 'mid' },
      { text: '自分にも、同じようなことはなかった？', zone: 'mid' },
      { text: 'この本のどこが面白かった？それはどうして？', zone: 'mid' },
      { text: '登場人物に言いたいことがあるとしたら、何を言う？', zone: 'end' },
      { text: '作者は、この本を通してどんなことを伝えたかったと思う？', zone: 'end' },
      { text: 'この本を読んで、こうなったらいいなと願うことは何？', zone: 'end' },
      { text: '同じ作者やにたテーマの本も読んでみたい？なぜ？', zone: 'end' }
    ],
    high: [
      { text: 'ほかに印象に残った場面やせりふ、言葉はある？', zone: 'mid' },
      { text: 'いちばん共感できた登場人物はだれ？どんなところに共感した？', zone: 'mid' },
      { text: 'この本を読んで、はじめて分かったことや考えが変わったことは？', zone: 'mid' },
      { text: 'ぎゃくに、なっとくできなかったところや、腹が立ったところはある？', zone: 'mid' },
      { text: '「どうしてこうなるんだろう」と考えこんだところはある？', zone: 'mid' },
      { text: '自分の経験で、この本の内容とにていることはある？', zone: 'mid' },
      { text: 'この本のどこを面白いと感じた？その理由を自分の言葉で説明してみよう', zone: 'mid' },
      { text: 'この本のテーマを、ニュースや身のまわりの出来事と結びつけて考えられることはある？', zone: 'mid' },
      { text: 'もし続きや別の結末があるとしたら、どんな物語を想像する？', zone: 'mid' },
      { text: '登場人物に言いたいことがあるとしたら、どんな言葉をかける？', zone: 'end' },
      { text: 'この本を読んで、これからの自分や世の中に願うことは何？', zone: 'end' },
